...
* @Last Modified by:   x
* @Last Modified time: 2018-02-08 12:58:40
*/
...
exports.Question = mongolass.model('Question', {
  ...
  choice_a: {type: 'string', required: true},
  choice_b: {type: 'string', required: true},
  choice_c: {type: 'string', required: true},
  choice_d: {type: 'string', required: true},
  correct_answer: {type: 'string', required: true}
});
exports.Question.index({subject_id: 1, set_id: 1, question_id: 1}, {unique: true}).exec();
